...
Beam_Patterns = cell(2,Minimum_Points);
    ...
    %the cell arrays
Maped_Directions = Start_Tick:5:(size(Direction_Clean2,2)-4)*5;
for beam_patterm = 1:Minimum_Points
    for rotation = 1:(size(Direction_Clean2,2)-3)
    ...
    Beam_Patterns{1,beam_patterm} = circshift(Maped_Directions, (size(Maped_Directions,2)/2));
end
